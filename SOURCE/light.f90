...
IMPLICIT NONE
INTEGER :: KJ
REAL :: LAI_above,space,frac,LAI_above_base,iPAR
!----------------------------------------------------------------------!
...
individuals_areas_above : DO I = 1, NIND_alive
  ...
  !--------------------------------------------------------------------!
  iPAR = (1.0 - shade (KI)) + shade (KI) * EXP (kext * LAI_above)
  !--------------------------------------------------------------------!
  ...
  !--------------------------------------------------------------------!
  iPAR_base (KI) = EXP (kext * LAI_above_base)
  !--------------------------------------------------------------------!
  ! fPAR of tree                                              (fraction)
  !--------------------------------------------------------------------!
  fPAR (KI) = iPAR * (1.0 - EXP (kext * LAIcrown (KI)))
  !--------------------------------------------------------------------!
